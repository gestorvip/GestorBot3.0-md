...
const spinner2 = { 
  "interval": 150,
  "frames": ["CANAL : Youtube.com/equipevipssh"]}
...
const banner2 = cfonts.render(('Canal: youtube.com/equipevipssh'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`Equipe vip 2.0`), {
font: 'tiny',             
align: 'center',           
...
authorname = 'EQUIPE-VIP-3.0'
packname = '-JR-'
  
function addMetadata(packname, author) {	
if (!packname) packname = '-JR-'; if (!author) author = 'EQUIPE-VIP-3.0';	
